/**
 * Original file at: https://github.com/ZoneMinder/ZoneMinder/blob/master/src/zm_monitor.cpp
 * OpenCCTV modifications are done at line number 3817 and
 * line number 3885.
 */
...
bool MonitorStream::sendFrame( const char *filepath, struct timeval *timestamp )
{
    ...
    else
    {
        ...
        // OpenCCTV modification starts
        long lTimeMs = (((long) timestamp->tv_sec)*1000) + (((long) timestamp->tv_usec)/1000);
        fprintf( stdout, "Timestamp: %ld - %s\r\n", lTimeMs, filepath );
        // OpenCCTV modification ends
